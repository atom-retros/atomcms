    ...
    <div class="w-full min-h-[60px] text-white px-5 relative">
        ...
        <div x-show="open" class="flex flex-col text-white gap-x-14 p-4 space-y-3">
            <x-navigation.dropdown route-group="help-center*" :show-chevron="true" :flex-col="false">
                ...
                <x-slot:children>
                    <x-navigation.dropdown-child :route="route('community.articles.index')">
                        {{ __('Articles') }}
                    </x-navigation.dropdown-child>


                    <x-navigation.dropdown-child :route="route('community.staff')">
                        {{ __('Staff') }}
                    </x-navigation.dropdown-child>

                    <x-navigation.dropdown-child :route="route('community.teams')">
                        {{ __('Teams') }}
                    </x-navigation.dropdown-child>

                    <x-navigation.dropdown-child :route="route('community.staff-applications.index')">
                    ...
                    <x-navigation.dropdown-child :route="route('community.photos')">
                        {{ __('Photos') }}
                    </x-navigation.dropdown-child>
                </x-slot:children>
            ...
            <x-navigation.dropdown route-group="help-center*"  :show-chevron="true" :flex-col="false">
                ...
                <x-slot:children>
                    ...
                    @guest
                        <x-navigation.dropdown-child :route="route('login.index')">
                            {{ __('Login') }}
                        </x-navigation.dropdown-child>


                        <x-navigation.dropdown-child :route="route('register.index')">
                            {{ __('Register') }}
                        </x-navigation.dropdown-child>
                    @endguest
                </x-slot:children>
