...
<head>
    ...
    @vite(['resources/views/' .  setting('theme') . '/css/app.scss', 'resources/views/' .  setting('theme') . '/js/app.js'], 'build')
    ...
    <div class="sub-header px-5 xl:px-0">
        <div class="max-w-7xl w-full h-[40px] flex items-center justify-between">
            ...
            <div class="flex gap-4 items-center">
                ...
                <a href="{{ route('help-center.rules') }}" class="transition duration-300 ease-in-out hover:scale-110">
