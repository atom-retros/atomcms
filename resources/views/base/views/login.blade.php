<x-app-layout>
    @push('title', __('title.login', ['name' => $settings->get('hotel_name')]))

    <x-form.form route="{{ route('login.store') }}" class="flex flex-col gap-6 p-3 bg-gray-100 rounded-lg dark:bg-gray-950">
