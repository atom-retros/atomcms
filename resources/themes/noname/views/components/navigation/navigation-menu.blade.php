<div class="hidden relative w-full h-full flex flex-col gap-y-2 py-3 items-center md:flex md:flex-row md:gap-x-8 md:gap-y-0 md:py-0 md:mt-1" id="mobile-menu">
    {{-- md:justify-between gap-x-8 uppercase font-bold text-[14px] mt-5 --}}
        ...
        <button
                ...
                class="{{ request()->routeIs('community.*') ? 'md:border-b-4 md:border-b-[#eeb425]' : '' }} nav-item gap-x-1">
                {{ __('Community') }}
