    ...
    <div class="col-span-12">
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
            <div class="rounded bg-white p-2 shadow dark:bg-gray-900">
                <div class="flex justify-center gap-x-1 text-center font-semibold text-gray-700 dark:text-gray-300">
                    <div class="flex items-center">
                        <img src="{{ asset('/assets/images/icons/credits.png') }}" alt="credits" class="w-4"
                ...
                <div class="mt-4 flex flex-col gap-y-3">
                    @foreach ($credits as $index => $user)
                        <div
                            class="p-3 rounded bg-gray-100 flex gap-x-2 items-center h-[70px] overflow-hidden dark:bg-gray-800">
                            <div @class([
            ...
            <div class="rounded bg-white p-2 shadow dark:bg-gray-900">
                <div class="flex justify-center gap-x-1 text-center font-semibold text-gray-700 dark:text-gray-300">
                    <div class="flex items-center">
                        <img src="{{ asset('/assets/images/icons/duckets.png') }}" alt="credits" class="w-4"
                            style="image-rendering: pixelated;">
                    </div>
                    {{ __('Top duckets') }}
                </div>
            ...
            <div class="rounded bg-white p-2 shadow dark:bg-gray-900">
                <div class="flex justify-center gap-x-1 text-center font-semibold text-gray-700 dark:text-gray-300">
                    <div class="flex items-center">
                        <img src="{{ asset('/assets/images/icons/diamond.png') }}" alt="credits" class="w-4"
                            style="image-rendering: pixelated;">
                    </div>
                    {{ __('Top diamonds') }}
                </div>
            ...
            <div class="rounded bg-white p-2 shadow dark:bg-gray-900">
                <div class="flex justify-center gap-x-1 text-center font-semibold text-gray-700 dark:text-gray-300">
                    <div class="flex items-center">
                        <img src="{{ asset('/assets/images/icons/clock.gif') }}" alt="clock" class="w-4"
                            style="image-rendering: pixelated;">
                    </div>
                    {{ __('Hours online') }}
                </div>
            ...
            <div class="rounded bg-white p-2 shadow dark:bg-gray-900">
                <div class="flex justify-center gap-x-1 text-center font-semibold text-gray-700 dark:text-gray-300">
                    <div class="flex items-center">
                        <img src="{{ asset('/assets/images/icons/heart.gif') }}" alt="heart" class="w-4"
                            style="image-rendering: pixelated;">
                    </div>
            ...
            <div class="rounded bg-white p-2 shadow dark:bg-gray-900">
                <div class="flex justify-center gap-x-1 text-center font-semibold text-gray-700 dark:text-gray-300">
                    <div class="flex items-center">
                        <img src="{{ asset('/assets/images/icons/star.gif') }}" alt="star" class="w-4"
                            style="image-rendering: pixelated;">
                    </div>
