...
@section('content')
    ...
    <div class="flex flex-col col-span-12 gap-3 lg:col-span-3">
        <x-card.base title="{{ __('Apply for :hotel staff', ['hotel' => $settings->get('hotel_name')]) }}" subtitle=" {{ __('Select position to get started', ['hotel' => $settings->get('hotel_name')]) }}" icon="chat">
