    <x-content.content-section icon="discord-icon" classes="border dark:border-gray-900">
        ...
        <div class=" text-sm dark:text-gray-200">
            <div id="guildUsers" class="max-h-[141px] overflow-auto"> </div>
            <a id="guildInvite" target="blank">
                <button
                    class="w-full rounded bg-green-600 hover:bg-green-700 text-white p-2 transition ease-in-out duration-150 font-semibold">
                    {{ __('Join server') }}
                </button>
            </a>
        </div>
