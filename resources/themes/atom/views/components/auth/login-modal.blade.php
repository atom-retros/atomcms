<div x-cloak x-show="open" @click.outside="open = false" x-transition class="bg-white dark:bg-gray-900 rounded absolute mx-auto top-0 md:top-64 z-[100] shadow-md">
