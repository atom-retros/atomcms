<footer
    class="flex flex-col items-center justify-center w-full mt-auto text-sm text-gray-400 bg-gray-100 h-14 dark:bg-gray-900 md:flex-row md:justify-center md:px-8"
    onclick="showFooter()">

    <div class="md:font-semibold text-[12px] md:text-[14px] cursor-pointer hover:underline">
        &copy {{ now()->format('Y') }} - {{ __(':hotel is a not for profit educational project', ['hotel' => $settings->get('hotel_name')]) }}
    </div>
</footer>
